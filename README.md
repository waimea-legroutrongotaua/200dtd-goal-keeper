...
My project will allow users to keep track of users cats and weather they have been feed along with how much cat food is left. I have two fussy cats who like some cat foods and not others. Being able to track what kinds of cat food they prefer would be useful as it would prevent them from not going hungry and discourage them from catching birds when hungry.
